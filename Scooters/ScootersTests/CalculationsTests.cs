...
namespace ScootersTests
{
    ...
    public class CalculationsTests
    {
        ...
        public void CalculateIncome_YearIsNullAndDoNotInclude_Returns35()
        {
            ...
            {
                new RentedUnit(1,firstId,DateTime.Now), 
                new RentedUnit(2,secondId,DateTime.Now)
            };
            decimal price = 0.5m;
            // Act
            ...
            rentHistory[0].Price = _calculations.CalculatePrice(rentHistory[0]);
            // Assert
        ...
        public void CalculateIncome_YearIsGivenAndDoNotInclude_Returns45()
        {
            ...
            IList<RentedUnit> rentHistory = new List<RentedUnit>
            {
                new RentedUnit(1,firstId,DateTime.Now.AddYears(-1)),
                new RentedUnit(2,firstId,DateTime.Now),
                new RentedUnit(3,secondId,DateTime.Now)
            };
            decimal price = 0.5m;
            // Act
            _calculations.ScooterService.AddScooter(firstId,price);
            ...
            rentHistory[1].Price = _calculations.CalculatePrice(rentHistory[1]);
            rentHistory[0].Price = 1000;
            // Assert
